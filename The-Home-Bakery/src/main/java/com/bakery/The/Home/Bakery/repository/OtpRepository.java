...
public interface OtpRepository extends JpaRepository<OtpEntity, Long> {
    ...
    @Query("SELECT o FROM OtpEntity o WHERE o.mobile = :mobile AND o.expiresAt > :now AND o.isUsed = false ORDER BY o.createdAt DESC")
    List<OtpEntity> findValidMobileOtps(@Param("mobile") String mobile, @Param("now") LocalDateTime now);
    ...
    @Modifying
    @Query("DELETE FROM OtpEntity o WHERE o.mobile = :mobile")
